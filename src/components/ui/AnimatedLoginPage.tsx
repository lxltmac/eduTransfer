...
export function AnimatedLoginPage({ onLogin, showNotification }: AnimatedLoginPageProps) {
  ...
  useEffect(() => {
    const savedUsername = localStorage.getItem('edu_username');
    const savedPassword = localStorage.getItem('edu_password');
    ...
    try {
      ...
      if (data.success) {
        if (rememberMe) {
          ...
          localStorage.setItem('edu_password', password);
        } else {
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 p-12 text-white">
        ...
        <div className="relative z-20 text-sm text-white/60">
          <p className="text-center">智慧校园文件传输系统</p>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-[420px]">
          ...
          <div className="lg:hidden flex items-center justify-center gap-2 text-lg font-semibold mb-12">
            ...
            <span className="text-slate-800">EduTransfer</span>
          </div>

          {/* Header */}
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight text-slate-800 mb-2">欢迎回来!</h1>
            <p className="text-slate-500 text-sm">请输入您的账号信息</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-white border-slate-200 focus:border-blue-500 focus:ring-blue-500/20"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center">
              ...
              <Label
                htmlFor="remember"
                className="text-sm font-normal cursor-pointer text-slate-600 ml-2"
              >
                记住我
              </Label>
            </div>
